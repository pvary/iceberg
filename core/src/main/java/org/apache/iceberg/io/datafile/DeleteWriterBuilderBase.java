...
/**
 * Base implementation for the {@link DeleteWriterBuilder} which handles the common
 ...
 */
public abstract class DeleteWriterBuilderBase<T extends DeleteWriterBuilderBase<T>>
    implements DeleteWriterBuilder<T> {
  ...
  protected DeleteWriterBuilderBase(AppenderBuilder<?> appenderBuilder, FileFormat format) {
