...
import static org.apache.iceberg.actions.RewritePositionDeleteFiles.REWRITE_JOB_ORDER_DEFAULT;
...
public class RewritePositionDeletesGroupPlanner
  ...
  public RewritePositionDeletesGroupPlanner(Table table, Expression filter) {
    super(table);
    this.filter = filter;
  }
